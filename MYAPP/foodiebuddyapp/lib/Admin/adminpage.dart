...
import 'package:foodiebuddyapp/Admin/content.dart';
...
class AdminPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xFFC9EFC6), // Background color same as app bar
          ...
          SliverAppBar(
            ...
            actions: [
              Padding(
                ...
                child: _buildProfileIcon(context), // Add profile icon as an action
              ),
            ],
          ),
          SliverToBoxAdapter(
            child: Center( // Centers the content in the middle
              child: Padding(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                                    context,
                                    MaterialPageRoute(builder: (context) =>ContentModerationPage()),
                                  );
                  },
...
// Dummy ProfileScreen for demonstration purposes
